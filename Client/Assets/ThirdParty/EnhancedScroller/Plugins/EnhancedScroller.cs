...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public EnhancedScrollerCellView StartCellView
        {
            get
            {
                return _activeCellViews.Count > 0 ? _activeCellViews[0] : null;
            }
        }
        
        public SmallList<EnhancedScrollerCellView> AllActiveCellViews
        {
            get
            {
        ...
        public EnhancedScrollerCellView EndCellView
        {
            get
            {
                return _activeCellViews.Count > 0 ? _activeCellViews[_activeCellViews.Count - 1] : null;
            }
        }
        ...
        public EnhancedScrollerCellView GetLastCellView()
        {
            if (_activeCellViews.Count > 0)
            {
                return _activeCellViews[_activeCellViews.Count - 1];
            }
        ...
        /// <returns></returns>
        public IEnumerator TweenPosition(TweenType tweenType, float time, float start, float end, Action tweenComplete, bool forceCalculateRange)
        {
