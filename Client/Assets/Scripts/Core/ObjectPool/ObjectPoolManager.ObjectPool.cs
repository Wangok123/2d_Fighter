        ...
        private sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    ...
                    if (Math.Abs(ExpireTime - value) < float.Epsilon)
                    {
                        return;
                    }
            ...
            public bool CanSpawn(string name)
            {
                ...
                LatLinkedListRange<Object<T>> objectRange = default(LatLinkedListRange<Object<T>>);
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, LatLinkedListRange<Object<T>>> objectRanges in m_Objects)
                {
