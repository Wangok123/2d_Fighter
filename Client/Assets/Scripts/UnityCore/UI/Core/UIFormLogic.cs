    ...
    public abstract class UIFormLogic : MonoBehaviour
    {
        ...
        public bool Visible
        {
            ...
            set
            {
                if (!m_Available)
                {
                    GameDebug.LogWarning("UI form '{0}' is not available.", Name);
                    return;
                }
        ...
        /// 界面初始化。
        /// </summary>
        /// <param name="mData">用户自定义数据。</param>
        protected internal virtual void OnInit(object mData)
        {
        ...
        /// </summary>
        /// <param name="mData">用户自定义数据。</param>
        protected internal virtual void OnOpen(object mData)
        {
            m_Available = true;
            Visible = true;
        }
