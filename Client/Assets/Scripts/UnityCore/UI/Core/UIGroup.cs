...
namespace UnityCore.UI.Core
{
        ...
        public sealed partial class UIGroup : IUIGroup
        {
            ...
            private readonly LatLinkedList<UIFormInfo> m_UIFormInfos;
            ...
            public UIGroup(string name, int depth, IUIGroupHelper uiGroupHelper)
            {
                ...
                m_UIFormInfos = new LatLinkedList<UIFormInfo>();
                m_CachedNode = null;
                Depth = depth;
            }
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                {
                    throw new Exception(
                        $"UI group '{m_Name}' not exists specified UI form '[{uiForm.SerialId}]{uiForm.UIFormAssetName}'.");
                }
