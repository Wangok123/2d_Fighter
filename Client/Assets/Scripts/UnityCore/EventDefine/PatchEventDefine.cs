...
namespace UnityCore.EventDefine
{
    public class PatchEventDefine
    {
        ...
        /// 补丁包初始化失败
        /// </summary>
        public class InitializeFailed : EventDefineBase
        {
        ...
        /// 补丁流程步骤改变
        /// </summary>
        public class PatchStepsChange : EventDefineBase
        {
            public string Tips;
        ...
        /// 发现更新文件
        /// </summary>
        public class FoundUpdateFiles : EventDefineBase
        {
        ...
        /// 下载进度更新
        /// </summary>
        public class DownloadUpdate : EventDefineBase
        {
        ...
        /// 资源版本请求失败
        /// </summary>
        public class PackageVersionRequestFailed : EventDefineBase
        {
            public static void SendEventMessage()
            {
        ...
        /// 资源清单更新失败
        /// </summary>
        public class PackageManifestUpdateFailed : EventDefineBase
        {
            public static void SendEventMessage()
            {
        ...
        /// 网络文件下载失败
        /// </summary>
        public class WebFileDownloadFailed : EventDefineBase
        {
