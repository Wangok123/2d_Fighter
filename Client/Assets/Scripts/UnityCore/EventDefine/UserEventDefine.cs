...
namespace UnityCore.EventDefine
{
    public class UserEventDefine
    {
        ...
        /// 用户尝试再次初始化资源包
        /// </summary>
        public class UserTryInitialize : EventDefineBase
        {
        ...
        /// 用户开始下载网络文件
        /// </summary>
        public class UserBeginDownloadWebFiles : EventDefineBase
        {
            public static void SendEventMessage()
            {
        ...
        /// 用户尝试再次请求资源版本
        /// </summary>
        public class UserTryRequestPackageVersion : EventDefineBase
        {
            public static void SendEventMessage()
            {
        ...
        /// 用户尝试再次更新补丁清单
        /// </summary>
        public class UserTryUpdatePackageManifest : EventDefineBase
        {
            public static void SendEventMessage()
            {
        ...
        /// 用户尝试再次下载网络文件
        /// </summary>
        public class UserTryDownloadWebFiles : EventDefineBase
        {
            public static void SendEventMessage()
            {
