...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.ChargeAttackRuntimeComponent))]
  public unsafe partial class ChargeAttackRuntimeComponentPrototype : ComponentPrototype<Quantum.ChargeAttackRuntimeComponent> {
    public FP CurrentKnockbackMultiplier;
    public AssetRef<KnockbackStatusEffectData> BaseKnockbackData;
    partial void MaterializeUser(Frame frame, ref Quantum.ChargeAttackRuntimeComponent result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.ChargeAttackRuntimeComponent component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.ChargeAttackRuntimeComponent result, in PrototypeMaterializationContext context = default) {
        result.CurrentKnockbackMultiplier = this.CurrentKnockbackMultiplier;
        result.BaseKnockbackData = this.BaseKnockbackData;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class ComboAttackRuntimeComponentPrototype : ComponentPrototype<Quantum.ComboAttackRuntimeComponent> {
    ...
    public void Materialize(Frame frame, ref Quantum.ComboAttackRuntimeComponent result, in PrototypeMaterializationContext context = default) {
        result.CurrentComboStep = this.CurrentComboStep;
        result.CurrentHitboxActiveTime = this.CurrentHitboxActiveTime;
        result.CurrentHitboxActiveDuration = this.CurrentHitboxActiveDuration;
        result.CurrentKnockbackStatusEffectData = this.CurrentKnockbackStatusEffectData;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class PlayerMovementComponentPrototype : ComponentPrototype<Quantum.PlayerMovementComponent> {
    ...
    public void Materialize(Frame frame, ref Quantum.PlayerMovementComponent result, in PrototypeMaterializationContext context = default) {
        result.CharacterMovementData = this.CharacterMovementData;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class PlayerStatusComponentPrototype : ComponentPrototype<Quantum.PlayerStatusComponent> {
    public AssetRef<StatusData> StatusData;
    public AssetRef<HitReactionData> HitReactionData;
    public Quantum.Prototypes.KnockbackStatusEffectPrototype KnockbackStatusEffect;
    partial void MaterializeUser(Frame frame, ref Quantum.PlayerStatusComponent result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
  ...
  public unsafe partial class ProjectileComponentPrototype : ComponentPrototype<Quantum.ProjectileComponent> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.ProjectileComponent result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.SkillFieldComponent))]
  public unsafe partial class SkillFieldComponentPrototype : ComponentPrototype<Quantum.SkillFieldComponent> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.SkillFieldComponent result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.SkillFieldComponent component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
