...
{
    [Preserve]
    public unsafe class SkillFieldSystem : SystemMainThreadFilter<SkillFieldSystem.Filter>, ISignalSpawnSkillField,
        ISignalDestroySkillField
    {
        ...
        public override void Update(Frame frame, ref Filter filter)
        {
            ...
            skillFieldData.OnSkillFieldTick(frame, filter.Entity, filter.SkillField);
        }
        ...
        public void SpawnSkillField(Frame frame, AssetRef<SkillFieldData> skillFieldDataRef, FPVector2 position, EntityRef owner)
        {
            ...
            skillFieldData.OnSkillFieldSpawned(frame, skillFieldEntity, skillField, owner, position);
        ...
        {
            var skillField = frame.Unsafe.GetPointer<SkillFieldComponent>(entityRef);
            ...
            skillFieldData.OnSkillFieldDestroyed(frame, entityRef, skillField);
        ...
        private void ExecuteTick(Frame frame, EntityRef skillFieldEntity, SkillFieldComponent* skillField, SkillFieldData skillFieldData)
        {
            ...
            if (hits.Count > 0)
            {
                for (int i = 0; i < hits.Count; i++)
                {
                    ...
                    skillFieldData.ApplyEffect(frame, skillField->Owner, hit.Entity, hit.Point);
