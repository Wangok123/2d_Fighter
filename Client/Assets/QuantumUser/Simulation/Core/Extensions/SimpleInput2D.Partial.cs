namespace Quantum {
  ...
  unsafe partial struct SimpleInput2D {
    public static implicit operator Input(SimpleInput2D pInput) {
      Input input = default;
    ...
    public static implicit operator SimpleInput2D(Input input) {
      SimpleInput2D pInput = default;
